...
| HARNESS-003 | Task     | Enforce Angular composition and reusable capability boundaries             | P1       | In review | HARNESS-001, TD-004      | `docs/tasks/HARNESS-003-angular-composition-and-capability-rules.md` |
