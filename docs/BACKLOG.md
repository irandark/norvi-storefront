...
| TD-005     | Tech debt | Refactor the project to comply with Angular composition and capability rules | P1    | In review | SHOP-003, HARNESS-003, TD-004 | `docs/tasks/TD-005-project-wide-angular-architecture-refactor.md` |
